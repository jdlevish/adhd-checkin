import CognitiveDistortionsQuiz from './CognitiveDistortionsQuiz';

export default function CognitiveDistortionsQuizModal({ open, onClose }) {
  if (!open) return null;
  return (
